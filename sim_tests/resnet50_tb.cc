...
SC_MODULE(Testbench){
  ...
  int argc = 1;
  char *argv[] = {const_cast<char*>("./Gemmini_test_resnet50")};
    ...
    if (!conv) {
      ...
      start = read_cycles();
        ...
        pool_with_col2im(conv_1_params.I, conv_1_params.J,
            ...
            conv_1_params.out_dim_pooled,
            (elem_t *) conv_1_out,  (elem_t *) conv_1_out_pooled, &conv_1_params);
    ...
    if (!conv) {
      start = read_cycles();
        ...
        im2col(conv_2_params.batch_size, conv_2_params.in_channels,
            ...
            (elem_t *) conv_1_out_pooled,(elem_t *)  conv_2_in, &conv_2_params);
        ...
        tiled_matmul_nn_auto(conv_2_params.I, conv_2_params.J, conv_2_params.K,
             (elem_t *) conv_2_in, (elem_t *) conv_2_w,  conv_2_b,  (elem_t *) conv_2_out,
        ...
        tiled_matmul_nn_auto(conv_2_params.I, conv_2_params.J, conv_2_params.K,
             (elem_t *) conv_1_out_pooled, (elem_t *) conv_2_w,  conv_2_b,  (elem_t *) conv_2_out,
            RELU, conv_2_params.output_scale, true,
            tiled_matmul_type, check, "conv_2");
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_3_params.I, conv_3_params.J, conv_3_params.K,
             (elem_t *) conv_3_in, (elem_t *) conv_3_w,  conv_3_b,  (elem_t *) conv_3_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        im2col(conv_5_params.batch_size, conv_5_params.in_channels,
            ...
            (elem_t *) conv_1_out_pooled,(elem_t *)  conv_5_in, &conv_5_params);
        ...
        tiled_matmul_nn_auto(conv_5_params.I, conv_5_params.J, conv_5_params.K,
             (elem_t *) conv_5_in, (elem_t *) conv_5_w,  conv_5_b,  (elem_t *) conv_5_out,
        ...
        tiled_matmul_nn_auto(conv_5_params.I, conv_5_params.J, conv_5_params.K,
             (elem_t *) conv_1_out_pooled, (elem_t *) conv_5_w,  conv_5_b,  (elem_t *) conv_5_out,
            NO_ACTIVATION, conv_5_params.output_scale, true,
            tiled_matmul_type, check, "conv_5");
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_6_params.I, conv_6_params.J, conv_6_params.K,
             (elem_t *) conv_4_out, (elem_t *) conv_6_w,  conv_6_b,  (elem_t *) conv_6_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_7_params.I, conv_7_params.J, conv_7_params.K,
             (elem_t *) conv_7_in, (elem_t *) conv_7_w,  conv_7_b,  (elem_t *) conv_7_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_8_params.I, conv_8_params.J, conv_8_params.K,
             (elem_t *) conv_7_out, (elem_t *) conv_8_w,  conv_8_b,  (elem_t *) conv_8_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_9_params.I, conv_9_params.J, conv_9_params.K,
             (elem_t *) conv_8_out, (elem_t *) conv_9_w,  conv_9_b,  (elem_t *) conv_9_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_10_params.I, conv_10_params.J, conv_10_params.K,
             (elem_t *) conv_10_in, (elem_t *) conv_10_w,  conv_10_b,  (elem_t *) conv_10_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_11_params.I, conv_11_params.J, conv_11_params.K,
             (elem_t *) conv_10_out, (elem_t *) conv_11_w,  conv_11_b,  (elem_t *) conv_11_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_12_params.I, conv_12_params.J, conv_12_params.K,
             (elem_t *) conv_11_out, (elem_t *) conv_12_w,  conv_12_b,  (elem_t *) conv_12_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_13_params.I, conv_13_params.J, conv_13_params.K,
             (elem_t *) conv_13_in, (elem_t *) conv_13_w,  conv_13_b,  (elem_t *) conv_13_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_14_params.I, conv_14_params.J, conv_14_params.K,
             (elem_t *) conv_13_out, (elem_t *) conv_14_w,  conv_14_b,  (elem_t *) conv_14_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        im2col_with_col2im(conv_11_params.I, conv_11_params.J,
            ...
            (elem_t *) conv_11_out, (elem_t *)  conv_15_in, &conv_15_params);
        ...
        tiled_matmul_nn_auto(conv_15_params.I, conv_15_params.J, conv_15_params.K,
             (elem_t *) conv_15_in, (elem_t *) conv_15_w,  conv_15_b,  (elem_t *) conv_15_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_16_params.I, conv_16_params.J, conv_16_params.K,
             (elem_t *) conv_14_out, (elem_t *) conv_16_w,  conv_16_b,  (elem_t *) conv_16_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_17_params.I, conv_17_params.J, conv_17_params.K,
             (elem_t *) conv_17_in, (elem_t *) conv_17_w,  conv_17_b,  (elem_t *) conv_17_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_18_params.I, conv_18_params.J, conv_18_params.K,
             (elem_t *) conv_17_out, (elem_t *) conv_18_w,  conv_18_b,  (elem_t *) conv_18_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_20_params.I, conv_20_params.J, conv_20_params.K,
             (elem_t *) conv_20_in, (elem_t *) conv_20_w,  conv_20_b,  (elem_t *) conv_20_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_21_params.I, conv_21_params.J, conv_21_params.K,
             (elem_t *) conv_20_out, (elem_t *) conv_21_w,  conv_21_b,  (elem_t *) conv_21_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_23_params.I, conv_23_params.J, conv_23_params.K,
             (elem_t *) conv_23_in, (elem_t *) conv_23_w,  conv_23_b,  (elem_t *) conv_23_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_24_params.I, conv_24_params.J, conv_24_params.K,
             (elem_t *) conv_23_out, (elem_t *) conv_24_w,  conv_24_b,  (elem_t *) conv_24_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_26_params.I, conv_26_params.J, conv_26_params.K,
             (elem_t *) conv_26_in, (elem_t *) conv_26_w,  conv_26_b,  (elem_t *) conv_26_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_27_params.I, conv_27_params.J, conv_27_params.K,
             (elem_t *) conv_26_out, (elem_t *) conv_27_w,  conv_27_b,  (elem_t *) conv_27_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        im2col_with_col2im(conv_24_params.I, conv_24_params.J,
            ...
            (elem_t *) conv_24_out, (elem_t *)  conv_28_in, &conv_28_params);
        ...
        tiled_matmul_nn_auto(conv_28_params.I, conv_28_params.J, conv_28_params.K,
             (elem_t *) conv_28_in, (elem_t *) conv_28_w,  conv_28_b,  (elem_t *) conv_28_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_29_params.I, conv_29_params.J, conv_29_params.K,
             (elem_t *) conv_27_out, (elem_t *) conv_29_w,  conv_29_b,  (elem_t *) conv_29_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_30_params.I, conv_30_params.J, conv_30_params.K,
             (elem_t *) conv_30_in, (elem_t *) conv_30_w,  conv_30_b,  (elem_t *) conv_30_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_32_params.I, conv_32_params.J, conv_32_params.K,
             (elem_t *) conv_31_out, (elem_t *) conv_32_w,  conv_32_b,  (elem_t *) conv_32_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_33_params.I, conv_33_params.J, conv_33_params.K,
             (elem_t *) conv_33_in, (elem_t *) conv_33_w,  conv_33_b,  (elem_t *) conv_33_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_35_params.I, conv_35_params.J, conv_35_params.K,
             (elem_t *) conv_34_out, (elem_t *) conv_35_w,  conv_35_b,  (elem_t *) conv_35_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_36_params.I, conv_36_params.J, conv_36_params.K,
             (elem_t *) conv_36_in, (elem_t *) conv_36_w,  conv_36_b,  (elem_t *) conv_36_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_38_params.I, conv_38_params.J, conv_38_params.K,
             (elem_t *) conv_37_out, (elem_t *) conv_38_w,  conv_38_b,  (elem_t *) conv_38_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_39_params.I, conv_39_params.J, conv_39_params.K,
             (elem_t *) conv_39_in, (elem_t *) conv_39_w,  conv_39_b,  (elem_t *) conv_39_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_41_params.I, conv_41_params.J, conv_41_params.K,
             (elem_t *) conv_40_out, (elem_t *) conv_41_w,  conv_41_b,  (elem_t *) conv_41_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_42_params.I, conv_42_params.J, conv_42_params.K,
             (elem_t *) conv_42_in, (elem_t *) conv_42_w,  conv_42_b,  (elem_t *) conv_42_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_44_params.I, conv_44_params.J, conv_44_params.K,
             (elem_t *) conv_43_out, (elem_t *) conv_44_w,  conv_44_b,  (elem_t *) conv_44_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_45_params.I, conv_45_params.J, conv_45_params.K,
             (elem_t *) conv_45_in, (elem_t *) conv_45_w,  conv_45_b,  (elem_t *) conv_45_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        im2col_with_col2im(conv_43_params.I, conv_43_params.J,
            ...
            (elem_t *) conv_43_out, (elem_t *)  conv_47_in, &conv_47_params);
        ...
        tiled_matmul_nn_auto(conv_47_params.I, conv_47_params.J, conv_47_params.K,
             (elem_t *) conv_47_in, (elem_t *) conv_47_w,  conv_47_b,  (elem_t *) conv_47_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_48_params.I, conv_48_params.J, conv_48_params.K,
             (elem_t *) conv_46_out, (elem_t *) conv_48_w,  conv_48_b,  (elem_t *) conv_48_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_49_params.I, conv_49_params.J, conv_49_params.K,
             (elem_t *) conv_49_in, (elem_t *) conv_49_w,  conv_49_b,  (elem_t *) conv_49_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_50_params.I, conv_50_params.J, conv_50_params.K,
             (elem_t *) conv_49_out, (elem_t *) conv_50_w,  conv_50_b,  (elem_t *) conv_50_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_51_params.I, conv_51_params.J, conv_51_params.K,
             (elem_t *) conv_50_out, (elem_t *) conv_51_w,  conv_51_b,  (elem_t *) conv_51_out,
    ...
    if (!conv) {
      start = read_cycles();
        ...
        tiled_matmul_nn_auto(conv_52_params.I, conv_52_params.J, conv_52_params.K,
             (elem_t *) conv_52_in, (elem_t *) conv_52_w,  conv_52_b,  (elem_t *) conv_52_out,
    ...
    if (!conv) {
        ...
        tiled_matmul_nn_auto(conv_53_params.I, conv_53_params.J, conv_53_params.K,
             (elem_t *) conv_52_out, (elem_t *) conv_53_w,  conv_53_b,  (elem_t *) conv_53_out,
    ...
    tiled_global_average_auto((elem_t *) conv_53_out, (elem_t *) average, conv_53_params.batch_size,
    ...
    tiled_matmul_nn_auto(fc_54_params.I, fc_54_params.J, fc_54_params.K,
         (elem_t *) average, (elem_t *) fc_54_w,  fc_54_b,  (elem_t *) fc_54_out,
